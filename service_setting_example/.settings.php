...
//            ],
            'otus.vacation.accessManager' => [
                'className' => AccessManager::class,
                'constructorParams' => [
                    [
                        'roleGroupMap' => [
                            UserRoles::ROLE_MODERATOR => Option::get('otus.vacation', 'otus_vacation_moderator_id'),
                            UserRoles::ROLE_EMPLOYEE => Option::get('otus.vacation', 'otus_vacation_employee_id')
                        ],
                        'roleUserMap' => [
                            UserRoles::ROLE_ACCOUNTANT => Option::get('otus.vacation', 'otus_vacation_account_id'),
                        ],
                    ],
                ],
            ],
